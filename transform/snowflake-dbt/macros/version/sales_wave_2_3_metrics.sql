{% macro sales_wave_2_3_metrics() %}
    ...
    {{
        null_negative_numbers(
            "raw_usage_data_payload['counts']['source_code_pushes']"
        )
    ...
    {{
        null_negative_numbers(
            "raw_usage_data_payload['counts']['auto_devops_enabled']"
        )
    ...
    {{
        null_negative_numbers(
            "raw_usage_data_payload['counts']['template_repositories']"
        )
    ...
    {{
        null_negative_numbers(
            "raw_usage_data_payload['counts']['ci_internal_pipelines']"
        )
    }} as ci_internal_pipelines_all_time_event,
    {{
        null_negative_numbers(
            "raw_usage_data_payload['counts']['ci_external_pipelines']"
        )
    ...
    {{
        null_negative_numbers(
            "raw_usage_data_payload['counts_monthly']['deployments']"
        )
    ...
    {{
        null_negative_numbers(
            "raw_usage_data_payload['counts']['secret_detection_jobs']"
        )
    ...
    {{
        null_negative_numbers(
            "raw_usage_data_payload['counts']['projects_jira_active']"
        )
    ...
    {{
        null_negative_numbers(
            "raw_usage_data_payload['counts']['protected_branches']"
        )
    ...
    {{
        null_negative_numbers(
            "raw_usage_data_payload['counts']['network_policy_drops']"
        )
    ...
    {{
        null_negative_numbers(
            "raw_usage_data_payload['counts']['service_desk_issues']"
        )
    ...
    {{
        convert_variant_to_boolean_field(
            "raw_usage_data_payload['prometheus_enabled']"
        )
