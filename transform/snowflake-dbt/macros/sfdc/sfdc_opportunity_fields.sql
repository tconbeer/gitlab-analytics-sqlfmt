{%- macro sfdc_opportunity_fields(model_type) %}
    ...
    with
        ...
        linear_attribution_base as (  -- the number of attribution touches a given opp has in total
            -- linear attribution IACV of an opp / all touches (count_touches) for
            -- each opp - weighted by the number of touches in the given bucket
        ...
        sfdc_opportunity_stage as (
            ...
            select *
            from
                {{ ref("sfdc_opportunity_stage_source") }}
        ...
        final as (
            ...
            select
                ...
                close_date_detail.first_day_of_fiscal_quarter
                as close_fiscal_quarter_date,
                ...
                as created_fiscal_quarter_name,
            ...
            left join
                ...
                on sfdc_opportunity.sales_accepted_date
                = sales_accepted_date.date_actual
            left join
                date_details as start_date
                on sfdc_opportunity.subscription_start_date::date
