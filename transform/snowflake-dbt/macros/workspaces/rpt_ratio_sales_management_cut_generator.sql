...
agg as (
    ...
    select
        ...
        {% for select_column in select_columns %}
        base_list.{{ select_column }}, {% endfor %}
    ...
    left join
        ...
        {% for select_column in select_columns %}
        and base_list.{{ select_column }} = sao_count.{{ select_column }} {% endfor %}

    left join
        win_rate on base_list.fiscal_quarter_name_fy = win_rate.fiscal_quarter_name_fy
        {% for select_column in select_columns %}
        and base_list.{{ select_column }} = win_rate.{{ select_column }} {% endfor %}
...
large_subtotal_no_mql_trial_new_logo as (
    ...
    where
        ...
        {% for select_column in select_columns %}
        and agg.{{ select_column }} != 'Total' {% endfor %}
...
where
    ...
    {% for select_column in select_columns %}
    and {{ select_column }} is not null {% endfor %}
