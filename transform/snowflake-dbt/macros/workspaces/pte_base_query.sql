...
select
    ...
    coalesce(crm_account_tsp_account_employees, 0)
    - coalesce(
        crm_account_tsp_account_employees_prev, 0
    ...
    coalesce(p1.self_managed_instance_count, 0)
    - coalesce(
