        ...
        select
            ...
            case
                ...
                when
                    ...
                    or dim_parent_campaign_id
                    = '7014M000001dnVOQAY'  -- GCP Partner campaign
                    or (
                        dim_parent_campaign_id = '7014M000001dn8MQAQ'
                        and (
                ...
                when
                    (
                        bizible_touchpoint_type
                        = 'Web Form'  -- added 2021-06-04 MSandP: 332
                        and (
                ...
                when
                    (
                        bizible_touchpoint_type
                        = 'Web Form'  -- added 2021-06-04 MSandP: 346
                        and (
                ...
                when
                    (
                        bizible_touchpoint_type
                        = 'Web Form'  -- added 2021-08-30 MSandP: 325
                        and (
                            (
                ...
                when
                    (
                        bizible_touchpoint_type
                        = 'Web Form'  -- added 2021-11-22 MSandP: 585
                        and (
                            (
                ...
                when
                    (
                        bizible_touchpoint_type
                        = 'Web Form'  -- added 2021-11-22 MSandP: 570
                        and (
                            (
                                bizible_form_url_raw like '%devopsgtm%'
                                or bizible_landing_page_raw like '%devopsgtm%'
            ...
            case
                ...
                when
                    ...
                    and campaign.gtm_motion
                    = 'CI (CI/CD)'  -- override for TechDemo Series
                then 'CI/CD'
                when
                    bizible_integrated_campaign_grouping in (
                ...
                when
                    dim_parent_campaign_id = '7014M000001vm9KQAQ'
                    and campaign.gtm_motion
                    = 'DevOps Platform'  -- override for TechDemo Series
                then 'DevOps'
                when
                ...
                when
                    dim_parent_campaign_id = '7014M000001vm9KQAQ'
                    and campaign.gtm_motion
                    = 'GITOPS'  -- override for TechDemo Series
                then 'GitOps'
                else null
            end as gtm_motion,
            iff(
            ...
            case
                when
                    touchpoint_id
                    ilike 'a6061000000CeS0%'  -- Specific touchpoint overrides
                then 'Field Event'
