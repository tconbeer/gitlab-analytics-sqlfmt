with
    ...
    renamed as (
        ...
        select
            ...
            nullif("ClosedWonIACV_Large_Target", '')::float
            as closed_won_iacv_large_target,
            ...
            nullif("SDR_PipeCreated_SMB_Target", '')::float
            as sdr_pipecreated_smb_target,
            ...
            nullif("SDR_ExpectedPipe_MM_Target", '')::float
