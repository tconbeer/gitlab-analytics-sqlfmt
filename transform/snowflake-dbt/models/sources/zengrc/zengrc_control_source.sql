with
    ...
    renamed as (
        ...
        select
            ...
            parse_json(custom_attributes) ['187'] ['value']::varchar
            as application_used,
            parse_json(custom_attributes) ['106'] ['value']::varchar
            as average_control_effectiveness_rating,
            parse_json(custom_attributes) ['107'] ['value']::varchar
            as control_deployment,
            parse_json(custom_attributes) ['116'] ['value']::varchar as control_level,
            parse_json(custom_attributes) ['182'] ['value']::varchar
            as control_objective,
            parse_json(custom_attributes) ['181'] ['value']::varchar
            as control_objective_ref_number,
            ...
            parse_json(custom_attributes) ['213'] ['value']::varchar
            as financial_statement_assertions,
            ...
            parse_json(custom_attributes) ['193'] ['value']::varchar
            as ipe_review_parameters,
            parse_json(custom_attributes) ['188'] ['value']::varchar
            as management_review_control,
            parse_json(custom_attributes) ['183'] ['value']::varchar
            as mitigating_control_activities,
            parse_json(custom_attributes) ['112'] ['value']::varchar
            as original_scf_control_language,
            parse_json(custom_attributes) ['175'] ['value']::varchar as process,
            parse_json(custom_attributes) ['184'] ['value']::varchar
            as process_owner_name,
            parse_json(custom_attributes) ['185'] ['value']::varchar
            as process_owner_title,
            parse_json(custom_attributes) ['12'] ['value']::number
            as relative_control_weighting,
            ...
            parse_json(custom_attributes) ['10'] ['value']::varchar
            as sample_control_implementation,
            parse_json(custom_attributes) ['11'] ['value']::varchar
            as scf_control_question,
            parse_json(custom_attributes) ['194'] ['value']::varchar
            as spreadsheet_name,
            parse_json(custom_attributes) ['195'] ['value']::varchar
