with
    ...
    renamed as (
        ...
        select
            ...
            parse_json(custom_attributes)[
                '116'
            ]['value']::varchar as control_level,
            parse_json(custom_attributes)[
                '182'
            ...
            parse_json(custom_attributes)[
                '186'
            ]['value']::varchar as control_type,
            parse_json(custom_attributes)[
                '214'
            ]['value']::varchar as coso_components,
            parse_json(custom_attributes)[
                '215'
            ]['value']::varchar as coso_principles,
            parse_json(custom_attributes)[
                '174'
            ]['value']::varchar as financial_cycle,
            parse_json(custom_attributes)[
                '213'
            ]['value']::varchar as financial_statement_assertions,
            parse_json(custom_attributes)[
                '117'
            ]['value']::varchar as gitlab_guidance,
            parse_json(custom_attributes)[
                '205'
            ]['value']::varchar as ia_significance,
            parse_json(custom_attributes)[
                '196'
            ]['value']::varchar as ia_test_plan,
            parse_json(custom_attributes)[
                '192'
            ]['value']::varchar as ipe_report_name,
            parse_json(custom_attributes)[
                '193'
            ...
            parse_json(custom_attributes)[
                '179'
            ]['value']::varchar as risk_event,
            parse_json(custom_attributes)[
                '178'
            ]['value']::varchar as risk_ref_number,
            parse_json(custom_attributes)[
                '10'
