with
    ...
    renamed as (
        ...
        select
            ...
            parse_json(custom_attributes) ['212'] ['value']::date
            as audit_completion_date,
            parse_json(custom_attributes) ['206'] ['value']::varchar
            as delegated_testing_owner,
            parse_json(custom_attributes) ['216'] ['value']::date
            as documentation_due_date,
            ...
            parse_json(custom_attributes) ['152'] ['value']::varchar
            as period_completed,
            ...
            parse_json(custom_attributes) ['147'] ['value']::varchar
            as system_effectiveness_rating,
            parse_json(custom_attributes) ['121'] ['value']::varchar
            as system_tier_level
