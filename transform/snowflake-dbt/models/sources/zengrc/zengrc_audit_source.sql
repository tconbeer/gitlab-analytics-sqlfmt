    ...
    renamed as (
        ...
        select
            ...
            parse_json(custom_attributes)[
                '66'
            ]['value']::varchar as audit_category,
            parse_json(custom_attributes)[
                '212'
            ...
            parse_json(custom_attributes)[
                '217'
            ]['value']::date as escalation_date,
            parse_json(custom_attributes)[
                '123'
            ]['value']::varchar as gitlab_assignee,
            parse_json(custom_attributes)[
                '149'
            ]['value']::varchar as inherent_risk,
            parse_json(custom_attributes)[
                '152'
            ]['value']::varchar as period_completed,
            parse_json(custom_attributes)[
                '151'
            ]['value']::varchar as period_created,
            parse_json(custom_attributes)[
                '150'
            ]['value']::varchar as residual_risk,
            parse_json(custom_attributes)[
                '147'
