    ...
    renamed as (
        ...
        select
            ...
            parse_json(custom_attributes)[
                '209'
            ]['value']::varchar as arr_impact,
            parse_json(custom_attributes)[
                '68'
            ]['value']::varchar as audit_period,
            parse_json(custom_attributes)[
                '173'
            ]['value']::varchar as caa_activity_type,
            parse_json(custom_attributes)[
                '70'
            ]['value']::boolean as is_external_audit,
            parse_json(custom_attributes)[
                '59'
            ...
            parse_json(custom_attributes)[
                '69'
            ]['value']::varchar as priority_level
