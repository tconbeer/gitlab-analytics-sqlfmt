with
    ...
    renamed as (
        ...
        select
            ...
            parse_json(custom_attributes)[
                '44'
            ]['value']::varchar as cia_impact,
            parse_json(custom_attributes)[
                '79'
            ]['value']::date as risk_identified_date,
            parse_json(custom_attributes)[
                '81'
            ]['value']::varchar as existing_mitigations,
            parse_json(custom_attributes)[
                '57'
            ]['value']::varchar as interested_parties,
            parse_json(custom_attributes)[
                '158'
            ]['value']::boolean as is_risk_ready_for_review_and_closure,
            parse_json(custom_attributes)[
                '46'
            ]['value']::varchar as risk_owner,
            parse_json(custom_attributes)[
                '74'
            ]['value']::varchar as risk_tier,
            parse_json(custom_attributes)[
                '160'
            ...
            parse_json(custom_attributes)[
                '45'
            ]['value']::varchar as root_cause,
            parse_json(custom_attributes)[
                '58'
            ]['value']::varchar as threat_source,
            parse_json(custom_attributes)[
                '148'
            ]['value']::boolean as is_tprm_related,
            parse_json(custom_attributes)[
                '75'
