with
    ...
    renamed as (
        ...
        select
            ...
            "Country"::varchar
            as country,  -- noqa:L059
            "Company Name"::varchar as companyname,
            "Website"::varchar
            as website,  -- noqa:L059
            ...
            "Est. IT Department Budget (in 000s)"::varchar
            as est_it_department_budget,  -- noqa:L026
            "Est. HR Department Budget (in 000s)"::varchar
            as est_hr_department_budget,  -- noqa:L026
            "Employees"::varchar
            as employees,  -- noqa:L059
