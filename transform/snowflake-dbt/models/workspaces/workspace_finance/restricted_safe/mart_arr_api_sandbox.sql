with
    dim_billing_account_api_sandbox as (

        select * from {{ ref("dim_billing_account_api_sandbox") }}
    ...
    dim_product_detail_api_sandbox as (
        ...
        select * from {{ ref("dim_product_detail_api_sandbox") }}

    ),
    dim_subscription_api_sandbox as (

        select * from {{ ref("dim_subscription_api_sandbox") }}
    ...
    joined as (
        ...
        select
            ...
            {{
                dbt_utils.surrogate_key(
                    [
                        "fct_mrr_api_sandbox.dim_date_id",
                        "dim_subscription_api_sandbox.subscription_name",
                        "fct_mrr_api_sandbox.dim_product_detail_id",
                    ]
                )
            }} as primary_key,
            ...
            dim_subscription_api_sandbox.subscription_start_month
            as subscription_start_month,
            dim_subscription_api_sandbox.subscription_end_month
            as subscription_end_month,

            -- billing account info
            dim_billing_account_api_sandbox.dim_billing_account_id
            as dim_billing_account_id,
            dim_billing_account_api_sandbox.sold_to_country as sold_to_country,
            dim_billing_account_api_sandbox.billing_account_name
            as billing_account_name,
            dim_billing_account_api_sandbox.billing_account_number
            ...
            dim_product_detail_api_sandbox.product_delivery_type
            as product_delivery_type,
            dim_product_detail_api_sandbox.service_type as service_type,
            dim_product_detail_api_sandbox.product_rate_plan_name
        ...
        inner join
            dim_subscription_api_sandbox
            on dim_subscription_api_sandbox.dim_subscription_id
            = fct_mrr_api_sandbox.dim_subscription_id
        inner join
            dim_product_detail_api_sandbox
            on dim_product_detail_api_sandbox.dim_product_detail_id
            = fct_mrr_api_sandbox.dim_product_detail_id
        inner join
            dim_billing_account_api_sandbox
            on dim_billing_account_api_sandbox.dim_billing_account_id
            = fct_mrr_api_sandbox.dim_billing_account_id
        inner join dim_date on dim_date.date_id = fct_mrr_api_sandbox.dim_date_id
        left join
            dim_crm_account
            on dim_billing_account_api_sandbox.dim_crm_account_id
