...
with
    prep_amendment_central_sandbox as (

        select * from {{ ref("prep_amendment_central_sandbox") }}

    ),
    subscription_central_sandbox as (

        select * from {{ ref("prep_subscription_central_sandbox") }}
    ...
    final as (
        ...
        select
            ...
            {{ get_keyed_nulls("prep_amendment_central_sandbox.dim_amendment_id") }}
        ...
        left join
            ...
            = subscription_central_sandbox.subscription_name_slugify
        left join
            prep_amendment_central_sandbox
            on subscription_central_sandbox.dim_amendment_id_subscription
            = prep_amendment_central_sandbox.dim_amendment_id
