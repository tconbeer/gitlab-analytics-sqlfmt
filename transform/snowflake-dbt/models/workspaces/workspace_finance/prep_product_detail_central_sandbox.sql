with
    zuora_central_sandbox_product as (

        select * from {{ ref("zuora_central_sandbox_product_source") }}

    ),
    zuora_central_sandbox_product_rate_plan as (

        select * from {{ ref("zuora_central_sandbox_product_rate_plan_source") }}

    ),
    zuora_central_sandbox_product_rate_plan_charge as (

        select * from {{ ref("zuora_central_sandbox_product_rate_plan_charge_source") }}
    ...
    common_product_tier as (
        ...
        select * from {{ ref("prep_product_tier_central_sandbox") }}

    ),
    common_product_tier_mapping as (

        select * from {{ ref("map_product_tier_central_sandbox") }}
    ...
    joined as (
        ...
        select
            -- ids
            zuora_central_sandbox_product_rate_plan_charge.product_rate_plan_charge_id
            ...
            zuora_central_sandbox_product_rate_plan.product_rate_plan_id
            ...
            zuora_central_sandbox_product_rate_plan_charge.product_rate_plan_charge_name
            ...
            lower(zuora_central_sandbox_product_rate_plan.product_rate_plan_name)
            ...
            min(
                zuora_central_sandbox_product_rate_plan_charge_tier.price
            ) as billing_list_price
        from zuora_central_sandbox_product
        inner join
            zuora_central_sandbox_product_rate_plan
            on zuora_central_sandbox_product.product_id
            = zuora_central_sandbox_product_rate_plan.product_id
        inner join
            zuora_central_sandbox_product_rate_plan_charge
            on zuora_central_sandbox_product_rate_plan.product_rate_plan_id
            = zuora_central_sandbox_product_rate_plan_charge.product_rate_plan_id
        inner join
            zuora_central_sandbox_product_rate_plan_charge_tier
            on zuora_central_sandbox_product_rate_plan_charge.product_rate_plan_charge_id
            = zuora_central_sandbox_product_rate_plan_charge_tier.product_rate_plan_charge_id
        left join
            common_product_tier_mapping
            on zuora_central_sandbox_product_rate_plan_charge.product_rate_plan_id
        ...
        where
            zuora_central_sandbox_product.is_deleted = false
    ...
    final
    as (  -- add annualized billing list price
