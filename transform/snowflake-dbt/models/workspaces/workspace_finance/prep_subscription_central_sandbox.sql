...
with
    ...
    zuora_central_sandbox_account as (
        ...
        select account_id, crm_id from {{ ref("zuora_central_sandbox_account_source") }}
    ...
    joined as (
        ...
        select
            ...
            zuora_central_sandbox_subscription.invoice_owner_id
            as dim_billing_account_id_invoice_owner,
            zuora_central_sandbox_subscription.sfdc_opportunity_id
            as dim_crm_opportunity_id,
            zuora_central_sandbox_subscription.original_id
            as dim_subscription_id_original,
            zuora_central_sandbox_subscription.previous_subscription_id
            as dim_subscription_id_previous,
            zuora_central_sandbox_subscription.amendment_id
            ...
            -- Date Information
            zuora_central_sandbox_subscription.subscription_start_date
            as subscription_start_date,
            zuora_central_sandbox_subscription.subscription_end_date
            as subscription_end_date,
            date_trunc(
                'month',
                zuora_central_sandbox_subscription.subscription_start_date::date
            ) as subscription_start_month,
            date_trunc(
                'month', zuora_central_sandbox_subscription.subscription_end_date::date
            ...
            date_trunc(
                'month', zuora_central_sandbox_subscription.term_start_date::date
            ) as term_start_month,
            date_trunc(
                'month', zuora_central_sandbox_subscription.term_end_date::date
            ) as term_end_month,
            case
                when
            ...
            zuora_central_sandbox_subscription.created_date::date
            as subscription_created_date,
            zuora_central_sandbox_subscription.updated_date::date
        ...
        inner join
            ...
            on zuora_central_sandbox_subscription.account_id
            = zuora_central_sandbox_account.account_id
        left join
        ...
        left join
            date_details
            on zuora_central_sandbox_subscription.subscription_end_date::date
