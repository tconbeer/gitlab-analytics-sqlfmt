...
with
    ...
    report_pipeline_metrics_day as (
        ...
        select
            ...
            case
                when base_fields.close_date = current_date then 1 else 0
            ...
            coalesce(
                report_quarter_plus_1.rq_plus_1_open_4plus_deal_count, 0
            ) as rq_plus_1_open_4plus_deal_count,
            ...
            coalesce(
                report_quarter_plus_2.rq_plus_2_open_4plus_deal_count, 0
            ) as rq_plus_2_open_4plus_deal_count,
            ...
            coalesce(
                report_quarter_plus_1.rq_plus_1_open_4plus_net_arr, 0
            ...
            coalesce(
                report_quarter_plus_2.rq_plus_2_open_4plus_net_arr, 0
            ...
            coalesce(
                minus_1_year_sao_gen.sao_deal_count, 0
            ) as minus_1_year_sao_deal_count,
            ...
            coalesce(
                minus_1_year_pipe_gen.pipe_gen_count, 0
