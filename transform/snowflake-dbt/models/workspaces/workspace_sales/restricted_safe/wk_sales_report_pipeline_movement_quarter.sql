...
with
    ...
    pipeline_type_start_ids as (
        ...
        where
            snapshot_fiscal_quarter_date
            = close_fiscal_quarter_date  -- closing in the same quarter of the snapshot
    ...
    pipeline_type_quarter_start as (
        ...
        where
            ...
            = starting.close_fiscal_quarter_date
            and starting_list.max_snapshot_day_of_fiscal_quarter_normalised
            = 5  -- exclude deals that were before day 5, unless they were at day 5
