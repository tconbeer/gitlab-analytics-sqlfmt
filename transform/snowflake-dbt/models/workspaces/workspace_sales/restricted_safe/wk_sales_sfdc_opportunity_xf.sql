...
with
    ...
    add_calculated_net_arr_to_opty_final as (
        ...
        select
            ...
            -- official table
            coalesce(
                net_iacv_to_net_arr_ratio.ratio_net_iacv_to_net_arr,
                0
            ...
            coalesce(
                agg_demo_keys.key_segment_geo_area, 'other') as key_segment_geo_area,
            ...
            coalesce(
                agg_demo_keys.sales_team_asm_level, 'other') as sales_team_asm_level
