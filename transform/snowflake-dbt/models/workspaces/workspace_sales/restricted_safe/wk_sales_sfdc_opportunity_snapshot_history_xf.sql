    ...
    sfdc_opportunity_snapshot_history_xf as (
        ...
        select distinct
            ...
            case
                when
                    ...
                    = 1  -- only consider won deals
                    and sfdc_opportunity_xf.opportunity_category
      ...
      */
        ...
        left join
            ...
            = sfdc_opportunity_xf.order_type_stamped
        where
            opp_snapshot.raw_account_id not in (
                '0014M00001kGcORQA0'
            )  -- remove test account
            and (
                sfdc_accounts_xf.ultimate_parent_account_id
