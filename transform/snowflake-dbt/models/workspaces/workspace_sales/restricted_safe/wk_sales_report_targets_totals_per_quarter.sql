...
with
    ...
    consolidated_targets_totals as (
        ...
        select
            ...
            coalesce(
                target.target_pipe_generation_net_arr,
                0
            ) as target_pipe_generation_net_arr,
            ...
            coalesce(
                total.total_pipe_generation_deal_count,
                0
            ) as total_pipe_generation_deal_count,
            ...
            coalesce(
                total.total_sao_generation_deal_count,
                0
            ) as total_sao_generation_deal_count,

            coalesce(
                total.total_created_and_booked_same_quarter_net_arr,
                0
            ) as total_created_and_booked_same_quarter_net_arr,
