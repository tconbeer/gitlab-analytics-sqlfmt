...
with
    ...
    final as (
        ...
        select
            ...
            coalesce(
                targets.total_sao_generation_deal_count,
                0
            ...
            coalesce(
                rq_plus_one.calculated_target_deal_count,
                0
            ...
            coalesce(
                rq_plus_two.calculated_target_deal_count,
                0
            ...
            coalesce(
                qtd_target.qtd_target_pipe_generation_net_arr,
                0
            ) as qtd_target_pipe_generation_net_arr,
            ...
            coalesce(
                year_minus_one.total_pipe_generation_deal_count,
                0
