...
rule_run_date as (
    ...
    from {{ ref("dim_date") }}
    where
        rule_run_date between '2021-06-23' and to_date(
            dbt_updated_at
        -- date when the code would be pushed to Production,we would be joining this
        -- with the dbt updated data for the models.
        )
