...
as (  -- Get subscription_id from self managed subscriptions
...
as (  -- Get subscriptions names that are currently paying ARR.
...
as (  -- Filter the amendments / subscription_versions to be of self managed    
...
subscription_to_licenses
as (  -- Join subscriptions to licenses
...
subscription_to_licenses_final
