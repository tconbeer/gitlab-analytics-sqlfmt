...
{{ config({"materialized": "incremental", "unique_key": "dim_board_id"}) }}
...
joined as (
    ...
    from boards_source
    left join dim_project on boards_source.project_id = dim_project.dim_project_id
    left join
        ...
        and boards_source.created_at < coalesce(
