...
saas_subscriptions as (
    ...
    inner join
        ...
        between '2017-04-01'
        and current_date  -- first month Usage Ping was collected
    where
...
gitlab_seats as (
    ...
    inner join
        dates
        on dates.date_actual
        between to_date(gitlab_subscriptions.valid_from) and ifnull(
            gitlab_subscriptions.valid_to, current_date
        )
    qualify
        row_number() over (
