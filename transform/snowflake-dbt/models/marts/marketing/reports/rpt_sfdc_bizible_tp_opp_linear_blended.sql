...
unioned as (
    ...
    select
        ...
        rpt_pmg_data.region_normalized
        as region_normalized,  -- 5       
        iff(
        ...
        null as sales_type,
        rpt_pmg_data.reporting_date_normalized
        as opp_created_date,  -- 10    
    ...
    select
        ...
        rpt_sfdc_bizible_linear.bizible_medium
        as bizible_medium,  -- 25
