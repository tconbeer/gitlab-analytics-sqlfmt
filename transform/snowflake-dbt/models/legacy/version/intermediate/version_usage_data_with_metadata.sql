...
joined as (
    ...
    left join  -- Join the latest version released at the time of the ping.
        ...
        on usage_data.created_at between latest_version.release_date and {{
            coalesce_to_infinity(
                "latest_version.next_version_release_date"
            )
        }}
    where
        (
...
renamed as (
    ...
    select
        ...
        usage_activity_by_stage_monthly[
            'manage'] ['events'] as monthly_active_users_last_28_days
