...
with
    ...
    period_exchange_rate_map
    as (  -- exchange rates used, by accounting period, to convert to parent subsidiary
        ...
        where
            consolidated_exchange_rates.to_subsidiary_id in (
                ...
                where
                    parent_id
                    is null  -- constrait - only the primary subsidiary has no parent
            )
    ...
    account_period_exchange_rate_map
    as (  -- account table with exchange rate details by accounting period
    ...
    as (  -- transaction line totals, by accounts, accounting period and subsidiary
